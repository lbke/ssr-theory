...
While we agree with the fact that client-side rendering leads to a slower user experience and unnecessary renders, we claim that personalized content can actually be pre-rendered, under the condition of adding a micro-server in front of the frontend application.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMTE4OTg2OTcsLTE1MjAyMTg1NDksMT
